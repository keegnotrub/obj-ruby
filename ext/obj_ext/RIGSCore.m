    ...
    switch (*type)
      ...
      case _C_CHARPTR: 
        if (*(char **)where == NULL)
          ...
          rb_val = rb_str_new_cstr(*(char **)where);
        break;
      ...
      case _C_SEL: 
        rb_val = rb_str_new_cstr(sel_getName(*(SEL*)where));
        break;
...
void
rb_objc_register_type_arg_from_objc(const char *selector, int index, const char *objcTypes)
{
  unsigned long hash;
  char *data;
